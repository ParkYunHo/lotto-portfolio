...
interface StaticsUseCase {
     ...
     * @since 2023.07.12
     */
    fun findPeriod(startDtStr: String, endDtStr: String, sortOption: String): Flux<StaticsInfo>
     ...
     * @since 2023.07.12
     */
    fun findDrwtNo(startDrwtNo: String, endDrwtNo: String, sortOption: String): Flux<StaticsInfo>
     ...
     * @since 2023.07.12
     */
    fun findWinAmount(startRank: String, size: String, isDesc: String, sortOption: String): Flux<StaticsInfo>
}